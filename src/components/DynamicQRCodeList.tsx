  ...
  return (
    <div className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {dynamicQRCodes.map((qrCode) => {
          const redirectUrl = getDynamicQRRedirectUrl(qrCode.short_code);
          
          return (
            <Card key={qrCode.id} className="shadow-sm hover:shadow-md transition-shadow duration-200">
              ...
              <CardContent className="flex flex-col items-center pt-4">
                <div 
                  className="bg-white p-2 rounded-md mb-4 w-36 h-36 flex items-center justify-center"
                  onClick={() => navigate(`/dynamic-qr/stats/${qrCode.id}`)}
                >
                  <img 
