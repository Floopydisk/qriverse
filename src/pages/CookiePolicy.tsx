          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-10">
                ...
                <p>
                  This Cookie Policy explains how QRGen uses cookies and similar technologies 
              ...
              <section className="mb-10">
                ...
                <p>
                  Cookies set by the website owner (in this case, QRGen) are called "first-party cookies." 
